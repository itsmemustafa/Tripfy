...
const AddPlaceModal = ({ isOpen, onClose, onAdd }) => {
    const [formData, setFormData] = useState({
        ...
        lat: '',
        lng: '',
        rating: '', // Default empty, user should set or it defaults to 0 from backend if omitted, but let's allow setting it
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await onAdd(placePayload);
            // Reset form
            setFormData({
                name: '', category: '', subcategory: '', description: '',
                city: '', lat: '', lng: '', rating: '', images: ['']
            });
            onClose();
        } catch (err) {
